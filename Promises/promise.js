/*
    ...
    Promise.any() => takes array as an arguments and seeks for resolve promise, if it gets promise resolved it responses that promise is resolved. If all promises are rejected it gives aggregated error (means array of rejection and error).
